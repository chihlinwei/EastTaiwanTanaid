# Community ecology and microhabitat association of Tanaidacea from Taiwan
...
The analysis folder contains the R codes (i.e., RMD files), which can be downloaded and opened in R studio. The HTML files integrate the R code and analysis outputs (e.g., figures and tables), which can be downloaded and viewed from a web browser.
